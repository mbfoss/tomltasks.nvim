" Vim filetype plugin for the tomltasks tasks file.
"
...
function! TomltasksTomlFold(lnum) abort
...
function! TomltasksTomlFoldText() abort
  let l:name = ''
...
setlocal foldexpr=TomltasksTomlFold(v:lnum)
setlocal foldtext=TomltasksTomlFoldText()
