...
---@class tomltasks.ui.StatusTree.Item
---@field id any
---@field data any

---@class tomltasks.ui.StatusTree.ItemDef
---@field id any
---@field data any

---@class tomltasks.ui.StatusTree.Opts
---@field filetype string?
---@field formatter fun(id:any, data:any, expanded:boolean):string[][], string[][]
---@field collapsible boolean?

local _ns_id = vim.api.nvim_create_namespace('tomltasksStatusTreeBuffer')

---@class tomltasks.ui.StatusTree
...
---@param opts tomltasks.ui.StatusTree.Opts
---@return tomltasks.ui.StatusTree
...
function StatusTree:create_buffer(on_deleted)
    ...
    self._bufnr = ui.create_scratch_buffer(false, {
        buftype    = "nofile",
        bufhidden  = "wipe",
        filetype   = self._filetype or "tomltasks-tree",
        modifiable = false,
        swapfile   = false,
        undolevels = -1,
        buflisted  = false,
...
---@param item tomltasks.ui.StatusTree.ItemDef
...
---@return tomltasks.ui.StatusTree.Item?
