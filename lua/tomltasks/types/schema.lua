...
---@alias tomltasks.IfRunning "wait"|"restart"|"refuse"|"parallel"
---@alias tomltasks.DependsOrder "sequence"|"parallel"

--- Glob-filtered form of a task's `save_buffers` field.
---@class tomltasks.TaskSaveBuffers
...
---@field depends_order? tomltasks.DependsOrder            how `depends_on` tasks are executed
---@field save_buffers?  boolean|tomltasks.TaskSaveBuffers save modified project buffers before running
...
---@param type_registry table<string, tomltasks.TaskTypeDef>
