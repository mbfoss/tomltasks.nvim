local Tree = require("easytasks.tk.Tree")
local uiutil = require("easytasks.tk.ui")
local Signal = require("easytasks.tk.Signal")

---@class easytasks.tk.TreeBuffer.Item
---@field id any
---@field data any
---@field expandable boolean
---@field expanded boolean

---@class easytasks.tk.TreeBuffer.ItemDef
---@field id any
---@field data any
---@field expandable boolean?
---@field expanded boolean?

---@class easytasks.tk.TreeBuffer.ItemData
---@field userdata any
---@field expandable boolean?
---@field expanded boolean?

---@alias easytasks.tk.TreeBuffer.FormatterFn fun(id:any, data:any, expanded:boolean):string[][], string[][]

---@class easytasks.tk.TreeBuffer.Opts
---@field filetype string?
---@field formatter easytasks.tk.TreeBuffer.FormatterFn
...
---@class easytasks.tk.TreeBuffer
---@field private _filetype string?
---@field private _formatter easytasks.tk.TreeBuffer.FormatterFn
...
---@field private _on_selection easytasks.tk.Signal<fun(id:any,data:any)>
---@field private _on_toggle easytasks.tk.Signal<fun(id:any,data:any,expanded:boolean)>
---@field private _bufnr integer
---@field private _ns_id integer
---@field private _tree easytasks.tk.Tree
...
---@param opts easytasks.tk.TreeBuffer.Opts
---@return easytasks.tk.TreeBuffer
function TreeBuffer.new(opts)
    ...
    return setmetatable({
        ...
        _on_selection   = Signal.new(), ---@type easytasks.tk.Signal<fun(id:any,data:any)>
        _on_toggle      = Signal.new(), ---@type easytasks.tk.Signal<fun(id:any,data:any,expanded:boolean)>
        _bufnr          = -1,
        _ns_id          = -1,
        _tree           = Tree.new(),
        _flat_ids       = {}, ---@type any[]
...
---@private
---@param flatnode easytasks.tk.Tree.FlatNode
---@param row integer
...
---@param new_flat easytasks.tk.Tree.FlatNode[]
...
---@private
---@return any?, easytasks.tk.TreeBuffer.ItemData?
...
---@param children easytasks.tk.TreeBuffer.ItemDef[]
---@return boolean
