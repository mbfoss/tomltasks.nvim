...
---@class easytasks.tk.extmarks.MarkInfo
---@field id number
---@field file string
...
---@class easytasks.tk.extmarks.MarkData
---@field id number
---@field ns number
---@field lnum number        -- 1-based
---@field col number        -- 0-based
...
---@alias easytasks.tk.extmarks.ById table<number, easytasks.tk.extmarks.MarkData>
---@alias easytasks.tk.extmarks.ByFile table<string, easytasks.tk.extmarks.ById>

---@class easytasks.tk.extmarks.GroupData
---@field ns number
---@field byfile easytasks.tk.extmarks.ByFile
---@field id_to_file table<number, string>

---@class easytasks.tk.extmarks.GroupInfo
---@field priority number
---@field data easytasks.tk.extmarks.GroupData

---@type table<string, easytasks.tk.extmarks.GroupInfo>
...
---@param bufnr integer
---@param mark easytasks.tk.extmarks.MarkData
...
---@param group_info easytasks.tk.extmarks.GroupInfo
...
local function _set_file_extmark(id, file, lnum, col, group_info, opts, user_data)
    ...
    ---@type easytasks.tk.extmarks.MarkData
    local mark = {
        id = id,
        ns = group_data.ns,
        lnum = lnum,
...
---@param id number
---@param group_info easytasks.tk.extmarks.GroupInfo
---@return easytasks.tk.extmarks.MarkInfo?
...
---@class easytasks.tk.extmarks.GroupFunctions
...
---@field get_extmark_by_id fun(id:number): easytasks.tk.extmarks.MarkInfo?
---@field get_extmark_by_location fun(file:string, line:number, live:boolean): easytasks.tk.extmarks.MarkInfo?
---@field get_extmarks fun(live:boolean): easytasks.tk.extmarks.MarkInfo[]
---@field get_file_extmarks fun(file:string, live:boolean): easytasks.tk.extmarks.MarkInfo[]
---@field refresh fun()
...
---@return easytasks.tk.extmarks.GroupFunctions
function M.define_group(group, group_opts)
    ...
    ---@type easytasks.tk.extmarks.GroupInfo
    local group_info = {
    ...
    ---@type easytasks.tk.extmarks.GroupFunctions
    return {
