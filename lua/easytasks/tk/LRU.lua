---@class easytasks.tk.LRU.Node
---@field key any
---@field value any
---@field prev easytasks.tk.LRU.Node?
---@field next easytasks.tk.LRU.Node?

---@class easytasks.tk.LRU
---@field _capacity integer
---@field _count integer
---@field _map table<any, easytasks.tk.LRU.Node>
---@field _head easytasks.tk.LRU.Node?
---@field _tail easytasks.tk.LRU.Node?
...
---@field new fun(self:easytasks.tk.LRU, capacity:integer, opts?:{on_evict?:fun(key:any, value:any), on_removed?:fun(key:any, value:any)}):easytasks.tk.LRU
local LRU = {}
LRU.__index = LRU
